...
app.layout= dbc.Container(
    [
        dcc.Markdown('## **Students of Service Data Display**'),
                    ...
                    dbc.Card(
                        dbc.CardBody([
                            ...
                            dcc.Dropdown(id='age-drop',
                                         options=[{'label': str(age), 'value': age} for age in sorted(clients['Age at Sign Up'].unique())],
                                         value=16)
                        ]),
                        className='my-2',
                        style={'height': '550px', 'marginBottom': '1rem'}
                    ),
                    dbc.Card(
                        dbc.CardBody([
                            html.H5("Value of Volunteered Time", className='card-title'),
                            html.H2(f"${get_hours_value()}", className='card-text')
                        ], style={'height': '100%'}),
                        className='my-2',
